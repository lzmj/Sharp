...
namespace SharpTools.Common
{
    ...
    {
    //    private List<Entity.ColumnInfo> _columns = new List<Entity.ColumnInfo>();
    ...
    //    public EntityBuilder(string tableName, string nameSpace, string className, List<Entity.ColumnInfo> columns, bool isView)
    //        : this(tableName, nameSpace, className, columns, isView, false)
    //    {

    //    }

    //    public EntityBuilder(string tableName, string nameSpace, string className, List<Entity.ColumnInfo> columns, bool isView, bool isSZMDX, string dbType = null)
    //    {
    //        _isSZMDX = isSZMDX;
    ...
    //    public List<Entity.ColumnInfo> Columns
    //    {
    //        get { return _columns; }
    //        set { _columns = value; }
    //    }
    ...
    //        Entity.ColumnInfo identityColumn = Columns.Find(delegate (Entity.ColumnInfo col) { return col.IsIdentity; });
    ...
    //        List<Entity.ColumnInfo> primarykeyColumns = Columns.FindAll(delegate (Entity.ColumnInfo col) { return col.IsPK; });
    ...
    //            StringPlus plus2 = new StringPlus();
    //            foreach (Entity.ColumnInfo col in primarykeyColumns)
    //            {
    ...
    //    /// <returns></returns>
    //    public static List<Entity.ColumnInfo> DbtoCSColumns(List<Entity.ColumnInfo> columns, string dbType)
    //    {
